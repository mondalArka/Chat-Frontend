...
export function SideBar({
    chats, selectedChatId, setSelectedChat, setRefresh, onSelectedChat,
            ...
            <div style={{
                ...
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "16px" }}>
                    ...
                    >
                        ...
                        {notification?.data?.some(n => !n.isRead)  && <div style={{
                            position: "absolute",
                            top: "5px", right: "5px",
                    ...
                    <button style={{
                        ...
                        width: "50px", height: "34px", cursor: "pointer",
                        color: "#94a3b8", fontSize: "15px", display: "flex",
